========================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : MSFlightSimDll-Projektübersicht
========================================================================


Der Anwendungs-Assistent hat diese MSFlightSimDll-DLL erstellt.
...
Die Datei enthält eine Zusammenfassung des Inhalts der Dateien für die MSFlightSimDll-DLL.

MSFlightSimDll.vcproj
...
MSFlightSimDll.h
    ...
    CMSFlightSimDllApp-Klasse.

MSFlightSimDll.cpp
    Dies ist die wichtigste DLL-Quelldatei. Sie enthält die Klasse CMSFlightSimDllApp.
MSFlightSimDll.rc
...
StdAfx.h, StdAfx.cpp
    ...
    mit der Bezeichnung MSFlightSimDll.pch und eine vorkompilierte Typdatei mit der Bezeichnung StdAfx.obj erstellt.

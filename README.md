...
![Settings Window](https://raw.github.com/X-Sim/X-PID-Arduino-PID-motor-control/master/img/xpid2.jpg)
...
![Settings Window](https://raw.github.com/X-Sim/X-PID-Arduino-PID-motor-control/master/img/xpid3.jpg)
...
![Settings Window](https://raw.github.com/X-Sim/X-PID-Arduino-PID-motor-control/master/img/pimp-a-pot.jpg)
Option two is something for RC car or plane model builders. You can reduce the pot movement by using gears on the same axis output as above. You have to go to the next local RC model dealer and calculate the exact fitting gear transmission. Insure you have 0 t 5 volts if you move the motor from the minimum to the maximum.
Feel free to visit our worthfull project gallery where you can see some other solutions like control rods and levers that control the pot.
http://www.x-sim.de/software.php?lang=eng&page=project_gallery
